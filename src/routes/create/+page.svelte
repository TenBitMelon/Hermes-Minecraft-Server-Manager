...
<form
  ...
  <div class="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
    <label class={`block`}>
      ...
      <div class={`${errors.title ? 'error-outline' : ''}`}>
        <input type="text" name="title" id="title" placeholder="Server Title" class="w-full rounded-md bg-gray-800 p-2 px-4 py-2 transition-all hover:bg-gray-750 focus:outline-none focus:ring-2 focus:ring-primary" />
    ...
    <label class={`block`}>
      ...
      <div class={`${errors.subdomain ? 'error-outline' : ''}`}>
        <input type="text" name="subdomain" placeholder="Subdomain" class="w-full rounded-md bg-gray-800 p-2 px-4 py-2 transition-all hover:bg-gray-750 focus:outline-none focus:ring-2 focus:ring-primary" />
  ...
  <div class={`grid grid-cols-2 gap-4 md:grid-cols-4 ${errors.timeToLive ? 'error-outline' : ''}`}>
    {#each Object.entries(TimeToLive) as [timeName, time]}
      <label class={`flex cursor-pointer items-center gap-2 rounded-md bg-gray-800 px-4 py-2 capitalize transition-all hover:bg-gray-750 has-[:checked]:text-primary has-[:checked]:ring-2 has-[:checked]:ring-primary`}>
  ...
  <div class={` flex flex-wrap gap-4 ${errors.gameVersion ? 'error-outline' : ''}`}>
    {#each ServerSoftwareOptions[selectedSoftware]?.versions ?? [] as version}
      ...
      <div class="group relative">
        <!-- Invisible first number just so the button are the right size and can be absolutely positioned -->
        ...
        <div class="absolute top-0 h-fit rounded-md bg-gray-800 shadow-lg hover:z-10">
          {#each version as versionNumber}
            <label
              class={`
                flex w-full cursor-pointer items-center justify-between gap-1 rounded-md px-4  py-2 text-left
                transition-all first:relative checked:block hover:bg-gray-750 group-hover:flex
  ...
  {#if ServerSoftwareOptions[selectedSoftware]?.newWorld || ServerSoftwareOptions[selectedSoftware]?.fromSource}
    ...
    {#if worldCreator == 'new'}
      ...
      <label class={`block ${errors.worldSeed ? 'error-outline' : ''}`}>
        <input type="text" class="w-full rounded-md bg-gray-800 p-2 px-4 py-2 transition-all hover:bg-gray-750 focus:outline-none focus:ring-2 focus:ring-primary" name="worldSeed" placeholder="World Seed" />
    ...
    {:else if worldCreator == 'source'}
      ...
      <label class={`block ${errors.worldSourceURL ? 'error-outline' : ''}`}>
        <input type="url" class="w-full rounded-md bg-gray-800 p-2 px-4 py-2 transition-all hover:bg-gray-750 focus:outline-none focus:ring-2 focus:ring-primary" name="worldSourceURL" placeholder="www.downloadlink.com" />
  ...
  <div class="grid grid-cols-2 gap-4 max-sm:flex max-sm:flex-col">
    ...
    <label class={`flex items-center justify-between rounded-md bg-gray-800 p-2 px-4 max-sm:order-1 ${errors.difficulty ? 'error-outline' : ''}`}>
      Difficulty
      <select name="difficulty" class="w-1/2 cursor-pointer rounded-md bg-gray-700 p-1 px-4 transition-all hover:bg-gray-650 focus:outline-none focus:ring-2 focus:ring-primary">
    ...
    <label class={`flex items-center justify-between rounded-md bg-gray-800 p-2 px-4 max-sm:order-2 ${errors.gamemode ? 'error-outline' : ''}`}>
      Gamemode
      <select name="gamemode" class="w-1/2 cursor-pointer rounded-md bg-gray-700 p-1 px-4 transition-all hover:bg-gray-650 focus:outline-none focus:ring-2 focus:ring-primary">
    ...
    <label class={`flex items-center justify-between rounded-md bg-gray-800 p-2 px-4 max-sm:order-3 ${errors.maxPlayers ? 'error-outline' : ''}`}>
      Max Players
      <input type="number" class="w-1/2 rounded-md bg-gray-700 p-1 px-4 text-center transition-all hover:bg-gray-650 focus:outline-none focus:ring-2 focus:ring-primary" name="maxPlayers" placeholder="Max Players" value="10" />
    </label>
    ...
    <label class={`flex items-center justify-between rounded-md bg-gray-800 p-2 px-4 max-sm:order-4 ${errors.viewDistance ? 'error-outline' : ''}`}>
      View Distance
      <input type="number" class="w-1/2 rounded-md bg-gray-700 p-1 px-4 text-center transition-all hover:bg-gray-650 focus:outline-none focus:ring-2 focus:ring-primary" value="16" name="viewDistance" placeholder="View Distance" />
    </label>
    ...
    <label class={`flex items-center justify-between rounded-md bg-gray-800 p-2 px-4 max-sm:order-5 ${errors.simulationDistance ? 'error-outline' : ''}`}>
      Simulation Distance
      <input type="number" class="w-1/2 rounded-md bg-gray-700 p-1 px-4 text-center transition-all hover:bg-gray-650 focus:outline-none focus:ring-2 focus:ring-primary" value="10" name="simulationDistance" placeholder="Simulation Distance" />
    </label>
  ...
  <div class="grid grid-cols-3 gap-4 max-sm:flex max-sm:flex-col">
    <label class={`flex cursor-pointer items-center justify-center gap-2 rounded-md bg-gray-800 p-2 transition-all hover:bg-gray-750 ${errors.eula ? 'error-outline' : ''}`}>
